...
§
Auxiliary vision: Xiaomi MiMo Token Plan. Endpoint: https://token-plan-cn.xiaomimimo.com/v1 (not api.* - that's for pay-as-you-go sk- keys). Model: mimo-v2-omni. TP key: tp-cr3x7...18r.
§
